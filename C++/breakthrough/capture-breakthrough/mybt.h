...
//------------    
    for(int i = 0; i < nb_white_pieces; i++) {
      ...
      if( (board[li-1][ci-1] == BLACK)&& (li-1 >= 0) && (li-1 < nbl) && (ci-1 >= 0) && (ci-1 < nbc) )
      {
        add_move(li, ci, li-1, ci-1);
        capture = true;
      }
      else if( (board[li-1][ci+1] == BLACK) && (li-1 >= 0) && (li-1 < nbl) && (ci+1 >= 0) && (ci+1 < nbc))
      {
        add_move(li, ci, li-1, ci+1);
        capture = true;
      }
...
//------------    
    for(int i = 0; i < nb_black_pieces; i++) {
      ...
      if( (board[li+1][ci-1] == WHITE) && (li+1 >= 0) && (li+1 < nbl) && (ci-1 >= 0) && (ci-1 < nbc) )
      {
        add_move(li, ci, li+1, ci-1);
        capture = true;
      }
      else if ( (board[li+1][ci+1] == WHITE) && (li+1 >= 0) && (li+1 < nbl) && (ci+1 >= 0) && (ci+1 < nbc) )
      {
        add_move(li, ci, li+1, ci+1);
        capture = true;
      }
