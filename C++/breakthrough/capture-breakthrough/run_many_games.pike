...
//------ vérification de capture --------
    ...
    if( ((player == 1) && (board[line_f*board_nbc+col_f] != '@')) || ((player == 2) && (board[line_f*board_nbc+col_f] != 'o')) )//verifier si le joueur fait une capture
    {
      for(int i = 0; i < board_nbl; i++)
      {
        for(int j = 0; j < board_nbc; j++)
        {
            if(player == 1)
            {
              if(board[i * board_nbc + j] == 'o')
              {
                if( (board[(i-1) * board_nbc + (j-1)] == '@') && (j-1 >= 0) && (j-1 < board_nbc) && (i-1 >= 0) && (i-1 < board_nbl))
                  return false;
                if( (board[(i-1) * board_nbc + (j+1)] == '@') && (j+1 >= 0) && (j+1 < board_nbc) && (i-1 >= 0) && (i-1 < board_nbl) )
                  return false;
              }
            ...
            if(player == 2)
            {
              if(board[i * board_nbc + j] == '@')
              {
                if( (board[(i+1) * board_nbc + (j-1)] == 'o') && (j-1 >= 0) && (j-1 < board_nbc) && (i+1 >= 0) && (i+1 < board_nbl) )
                  return false;
                if( (board[(i+1) * board_nbc + (j+1)] == 'o') && (j+1 >= 0) && (j+1 < board_nbc) && (i+1 >= 0) && (i+1 < board_nbl) )
                  return false;
              }
