...
message = "v.vlukyu,fwtfyooyn.ws" #vive la programmation (4,21)

determiner_cle(message)

print()
print("Cela ne marche pas car e et espace ne sont pas les lettres les plus fréquente (max et second_max")
