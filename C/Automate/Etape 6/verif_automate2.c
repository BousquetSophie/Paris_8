...
int main()
{
	...
	char tab_occ_obtenir[8][100] = {"BSQO","BQOO","BSQ","BQ","BQOO","BQO","BSQ","BSQ"};
	
	int tab_indice_obtenir[8][2]={{0,3},{7,10},{15,17},{26,27},{30,33},{48,50},{52,54},{61,63}};
	
	int nb_occ_obtenir = 8;
